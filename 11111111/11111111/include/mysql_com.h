...
typedef struct st_net {
  ...
  */
  ...
  char save_char;
  bool unused1; /* Please remove with the next incompatible ABI change */
  bool unused2; /* Please remove with the next incompatible ABI change */
  bool compress;
  bool unused3; /* Please remove with the next incompatible ABI change. */
  /*
  ...
  */
  ...
  unsigned char error; 
  bool unused4; /* Please remove with the next incompatible ABI change. */
  bool unused5; /* Please remove with the next incompatible ABI change. */
